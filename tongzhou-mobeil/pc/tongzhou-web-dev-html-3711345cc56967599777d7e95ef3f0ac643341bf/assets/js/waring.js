$(document).ready(function() {
    ...
    function operateFormatter(value, row, index) {
        return [
            '<a class="operate operate-propertyMgmt" href="javascript:void(0)" data-toggle="tooltip" data-placement="bottom" title="消警">',
            '<i class="fa fa-address-card-o" aria-hidden="true"></i>',
            '</a>  ',
            '<a class="operate operate-stationMgmt" href="javascript:void(0)" data-toggle="tooltip" data-placement="bottom" title="处理">',
